...
#define POWERSAVE
/* JRL attempt to disable powersave for run_alpha_algo
 * Goal : see if less power interruption => result: if no powersave:
 * the robots stops almost immediately after start */

/* JRL attempt 2 to solve auto-reset and auto-switch off issue 
 with run_alpha_algo
 - changing MAXV -> like this: powersave enabled all the time 
 - keeping same THRESHV*/

//#define TRESHV 850
//// phase kept on 1/THRESHV second
//#define MAXV 801
//// powersave enabled for speed < MAXV

/* Jean-Roch LAUER, october 2020
 * very slight adaptation of the original program 
 * to enable stopping the program with the remote control
 * => basically : 
 * - addition of a function for the initialization of the very first run
 * - I let the main loop managed in main.c instead of while(1) here
